...
import { getBoards, deleteBoard, saveBoard } from "../data/boardStorage"; 
import EditBoardForm from "../components/EditBorderForm"; 
    ...
    <>
      ...
      <div className="flex flex-wrap justify-center gap-4 relative mt-3 ">
        {filteredBoards.map((board) => (
          <div>
            <div key={board.id} className="flex w-34 max-w-lg mx-auto bg-white shadow-lg rounded-lg" >
              {/* Left Side - Color Block */}
              <div className={`w-20 ${board.color} rounded-l-lg`}></div>
                ...
                <div className="flex">
                  ...
                  <div>
                    {showActions === board.id && (
                      <div className="absolute top-10 left-[80%] bg-white shadow-lg border border-gray-200 rounded-lg w-35 z-50">
                        <div className="bg-white p-2 flex flex-col rounded-lg space-y-1" onMouseLeave={() => toggleActions(board.id)}>
                          <button
